...
python_code_path = str(Path(__file__).parent.parent.parent.parent.parent)
...
parent5 = current_file.parent.parent.parent.parent.parent
ec_ppi_path = parent5/'data/ec/Ec PPI Network.csv'
ppi_edges_ec = []
...
ec_key_genes = extract_gene_names_from_file(parent5/"data/ec/Ec Key Proteins.tsv")

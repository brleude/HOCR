...
all_rankings_all = {
    ...
    'CSR_8': csr_scores_8,
    'CSR_9': csr_scores_9,
    'CSR_10': csr_scores_10,
    'CSR_11': csr_scores_11,
    'CSR_12': csr_scores_12
}
all_results_all = calculate_all_metrics(all_rankings_all, key_proteins, non_key_proteins, top_n)

# 将数据转换为表格并保存为 CSV 文件
csv_file_path = '酿酒酵母PPI网络CSR_n(n=3,...,12)的六种统计指标.csv'
table = data_to_table(all_results_all, csv_file_path, file_format='csv')
print(table)
